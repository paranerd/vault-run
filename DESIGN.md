...
Die Hauptszene ist auf Smartphones fest auf `100dvh` ausgelegt und scrollt nicht. Unter dem Header liegen von oben nach unten Truhe, Beutel und Mine als drei exakt gleich hohe Abschnitte. Ein Pixel-Art-Trennstreifen benennt den Abschnitt. Darunter stehen links vier Stats-Plätze im 2×2-Raster, mittig Hauptaktion und eigener Ausrüstungs-Button sowie rechts vier Slot-Upgrades im 2×2-Raster. Beutel und Mine zeigen den Fortschritt eines manuellen Transports direkt als von unten nach oben wachsende goldene Füllung ihrer Aktions-Buttons; der separate Minenbalken entfällt. Der Beutel- und Truhenbalken zeigen ihre Füllstände. Ist der Beutel voll, pulsiert die Transportaktion. Die Schatztruhe bleibt bis zur ersten Goldlieferung ausgegraut. Erzeugtes Gold fliegt auf leicht variierenden Bahnen zum Beutel.
...
Ein kompakter Header zeigt einen Einstellungs-Button, das sichere Gold und einen Statistik-Button. Sounds und der zweistufig bestätigte Spielneustart liegen ausschließlich im Einstellungs-Popup. Der mittlere Ausbau-Button jedes Abschnitts öffnet ausschließlich dessen Ausrüstungs-Upgrade. Ein Tap auf einen der vier rechten Slots öffnet die jeweilige Vierergruppe und fokussiert den gewählten Slot. Noch nicht gekaufte Slot-Karten sind mit Ausnahme ihres Kauf-Buttons ausgegraut. Diese Ausbau-Seiten scrollen intern, die Hauptansicht selbst nie.

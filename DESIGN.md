...
Jede Karte trägt genau **eine Zahl**: den Zuwachs, den der Kauf obendrauf legt — `+0,7 Gold/s`, `+12 Gold je Fuhre`, `+2 Punkte je Sicherung`. Sie steht hervorgehoben unmittelbar links vom Preis: was der Kauf bringt, was er kostet. Kein „vorher → nachher“ und keine Summe über die Gruppe — der Bestand steht ohnehin auf der Kachel des Abschnitts, und zwei Zahlen nebeneinander sind schon eine Rechenaufgabe. Bringt eine Stufe rechnerisch nichts, steht dort `±0`; eine Karte, die zum Kauf auffordert, muss das zeigen.

Diese Zahl **darf sich nicht ändern, wenn nebenan gekauft wird**. Bei den Bergleuten ist das geschenkt: Ein Stollen fördert für sich. Fuhrknechte und Wachen wirken dagegen als Gespann — die Fuhre ist die Summe aller Ladungen, die Sicherungskraft die Summe aller Wachstufen. Beide Größen sind aber additiv, sodass der gemessene Zuwachs stehen bleibt, sobald das Gespann einmal steht. Gemessen wird deshalb an der tatsächlichen Gruppengröße und nicht am Slot allein: Die Fuhre hat ein Mindestmaß von 20 Gold, und solange dieses greift, bringt eine weitere Stufe wirklich nichts — die Karte verspricht dann keine Ladung, die längst abgedeckt ist. Was mehrere Slots nur gemeinsam bewirken — die kürzere Fahrzeit, der Takt des Wachtrupps, der Schadensdeckel — hätte auf keiner einzelnen Karte eine Zahl, die nur zu ihr gehört, und steht darum im Hinweis über der Gruppe.

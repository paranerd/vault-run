...
**Wer dasselbe tut, trägt denselben Namen — und damit dieselbe Skala.** Das ergibt eine geschlossene Tabelle: Pickhacke und Bergmann heißen beide **Fördermenge**; Beutel und Fuhrknecht beide **Ladung**; Grubenlampe und Wache beide **Sichtweite**; Stiefel, Fuhrknecht und Wache alle drei **Geschwindigkeit**. Jedem Attribut eines Angestellten steht damit ein Ausrüstungsstück des Spielers gegenüber, das dasselbe für ihn tut — der Fuhrknecht hat Ladung und Tempo, der Spieler hat dafür Beutel und Stiefel; die Wache hat Sichtweite und Tempo, der Spieler hat dafür Lampe und Stiefel. Nur die **Kraft** der Wachen steht allein, weil sie erst als Summe des Trupps wirkt.

Die Geschwindigkeit hieß bei Fuhrknecht und Wache bis eben **Dauer** und wurde mit jeder Stufe kleiner, während dieselbe Größe beim Spieler als Geschwindigkeit wuchs. Alle drei messen jetzt an derselben **Standardstrecke**: Wer sie in zwölf Sekunden zurücklegt, hat Tempo 1. Das ist keine Rechenkonvention, sondern fällt zusammen — die Fuhre des Spielers, die Fuhre eines Fuhrknechts der ersten Stufe und die Runde einer Wache der ersten Stufe dauern alle zwölf Sekunden. „Geschwindigkeit 1,9“ auf der Packesel-Karte ist damit unmittelbar gegen „Geschwindigkeit 1,3“ auf der Stiefelkarte lesbar. Der Wachgang des Spielers ist demgegenüber kein schnellerer Weg, sondern ein kürzerer (1,5 s): Er späht um die Truhe, statt sie zu umrunden. Lager und Truhe heißen **Kapazität** — auf ihrer Karte, wo die Grenze zu einer Entscheidung gehört; in der Szene steht statt ihrer der **Füllstand**. Die Stiefel heißen als einzige **Geschwindigkeit** — und zwar, weil sie als einzige nichts tun, was eine eigene Dauer hätte: Sie sind kein Takt, sondern ein Tempo auf zwei fremden Strecken. Vorher standen deshalb zwei Zeilen auf ihrer Karte, **Dauer Fuhre** und **Dauer Wachgang**, und beide Zahlen wurden mit jedem Kauf *kleiner* — die einzige Stelle im Spiel, an der ein Fortschritt nach unten zeigte.

**Dass ein wachsendes Tempo die Wege trotzdem verkürzt, ist keine Sonderregel, sondern die Definition von Tempo.** Eine Strecke kostet `Länge ÷ Geschwindigkeit`. Länge und Tempo sind seither getrennte Größen — 12 s für die Fuhre und 1,5 s für den Wachgang, gemessen am Tempo 1 —, und die wachsende Zahl steht im Nenner. Damit gibt es keine Stelle mehr, an der ein „mehr ist besser“ von Hand in ein „weniger ist besser“ übersetzt werden müsste: Die Richtung fällt aus der Rechnung, nicht aus einer Konvention. Der Faktor ist der Kehrwert des früheren 0,88, jede Stufe macht also denselben Sprung wie vorher — nur von der anderen Seite gelesen.

**Die Weglängen sind Konstanten und bleiben es.** Eine Zeit lang wuchsen sie mit dem Reich — die Fuhre mit dem Gewicht des Beutels, der Wachgang mit dem Umfang der Truhe. Fiktional stimmte das, mechanisch kostete es mehr, als es einbrachte: Aus zwei Karten wurde ein Handel, dessen zweite Zeile mit dem Kauf **wuchs** und trotzdem der Preis war — eine längere Fuhre liest sich nicht als Verschlechterung. Dazu band es die Zahlen einer Karte an Käufe in einem anderen System (ein Lager-Ausbau verlängerte die Fuhre, weil er den Beutel-Deckel hob) und verletzte damit die Regel, dass eine Zahl stehen bleibt, wenn man nebenan kauft. Für die Wachen wäre es zusätzlich das zweite Mittel mit derselben Wirkung gewesen wie der Risiko-Faktor je Truhenstufe.

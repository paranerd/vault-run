...
| Beutel | Ladung | die eigene Fuhre | ×1,5 je Stufe, gedeckelt aufs Lager; verlängert den Weg |
...
Benannt wird jeweils die Größe, die sich bewegt: Eine Wache hat **Sichtweite**, **Dauer** und **Kraft** — was eine Sicherung abträgt, wie lange sie bis zur nächsten braucht und was sie beiträgt, wenn es doch knallt —, nicht „Risiko -x %“. Pickhacke und Bergmann heißen beide **Fördermenge**, weil beide dasselbe tun; Beutel und Fuhrknecht beide **Ladung**, Grubenlampe und Wache beide **Sichtweite**. Lager und Truhe heißen **Kapazität** — auf ihrer Karte, wo die Grenze zu einer Entscheidung gehört; in der Szene steht statt ihrer der **Füllstand**. Die Stiefel heißen als einzige **Geschwindigkeit** — und zwar, weil sie als einzige nichts tun, was eine eigene Dauer hätte: Sie sind kein Takt, sondern ein Tempo auf zwei fremden Strecken. Vorher standen deshalb zwei Zeilen auf ihrer Karte, **Dauer Fuhre** und **Dauer Wachgang**, und beide Zahlen wurden mit jedem Kauf *kleiner* — die einzige Stelle im Spiel, an der ein Fortschritt nach unten zeigte.

**Dass ein wachsendes Tempo die Wege trotzdem verkürzt, ist keine Sonderregel, sondern die Definition von Tempo.** Eine Strecke kostet `Länge ÷ Geschwindigkeit`. Länge und Tempo sind seither getrennte Größen — 12 s für die Fuhre und 1,5 s für den Wachgang auf dem Anfangstempo —, und die wachsende Zahl steht im Nenner. Damit gibt es keine Stelle mehr, an der ein „mehr ist besser“ von Hand in ein „weniger ist besser“ übersetzt werden müsste: Die Richtung fällt aus der Rechnung, nicht aus einer Konvention. Der Faktor ist der Kehrwert des früheren 0,88, jede Stufe macht also denselben Sprung wie vorher — nur von der anderen Seite gelesen.

**Beide Seiten wachsen: Die Stiefel machen ihn schneller, sein Reich macht die Wege länger.** Eine Länge ist keine Konstante des Spiels, sondern eine Eigenschaft dessen, was der Spieler gerade zurücklegt — und beides wächst mit dem, was er sich aufgebaut hat.

- **Die Fuhre wird durch den Beutel länger.** Ein größerer Beutel bringt mehr Gold pro Weg und macht denselben Weg zugleich zäher. Der Weg wächst mit der Ladung hoch **0,35**: Der Beutel trägt je Stufe die anderthalbfache Ladung, der Weg wird dabei nur um gut 15 % länger, der Durchsatz wächst also weiter — um rund 30 % je Stufe statt der früheren 50 %. Der Preis des Beutels folgt diesem kleineren Zuwachs (Faktor 1,5 statt 1,7), sonst wäre er plötzlich der schlechteste Kauf im Spiel. Damit sind Beutel und Stiefel keine zwei unabhängigen Boni mehr, sondern ein Paar: Der eine schafft Last, der andere trägt sie weg.

  Gemessen wird an der **tatsächlich geschulterten** Ladung, nicht an der Beutelstufe. Das ist nicht bloß genauer, sondern notwendig: Die Ladung ist auf das Lager gedeckelt, und ein Beutel über der Lagergröße trägt kein Gramm mehr. Hinge das Gewicht an der Stufe, wäre so ein Kauf rein schädlich — mehr Weg für dieselbe Ladung. So stehen beide Zeilen der Karte still und sagen gemeinsam, dass zuerst das Lager wachsen muss.

- **Der Wachgang wird durch die Truhe länger** (+10 % je Truhenstufe). Er ist die Runde **um** die Truhe, und ein Drachenhort lässt sich nicht in derselben Zeit ablaufen wie eine morsche Holzkiste. Das ist die zweite Kehrseite des Truhenausbaus neben dem Risiko-Faktor — und die einzige, die man sehen kann: Sie steht als Zeile auf der Truhenkarte, während der Risiko-Faktor nirgends steht, weil er keine Eigenschaft der Truhe ist, sondern des Horts darin. Der Faktor ist bewusst klein, weil beide Größen in dieselbe Richtung ziehen und der Wachgang währenddessen alle drei Aktionen des Spielers sperrt.

Beide Karten zeigen deshalb **zwei** Zeilen: erst was der Kauf einträgt, dann was er kostet. Die zweite Zeile wächst und ist trotzdem der Preis — eine längere Fuhre ist keine bessere. Sie muss stehen, weil sie sonst die einzige Wirkung eines Kaufs wäre, die man nirgends liest.
...
Der mitwachsende Wachweg löst dabei ein Problem, das der feste hatte: Bei einer Länge von konstant 1,5 s erreichte der Wachgang seinen halben-Sekunden-Boden schon bei Stiefelstufe 9, und von da an wirkte die Hälfte der Stiefel auf nichts mehr. Wächst der Weg mit der Truhe, wandert der Boden mit — dieselbe Überlegung wie beim Risiko-Faktor je Truhenstufe: Eine Konstante gegen eine unbegrenzte Gegenkraft geht nur einmal aus.
...
Ein Gegenmittel steckt in der Truhe selbst: Weil das Risiko am Füllstand hängt, senkt jeder Ausbau der Schatztruhe den Druck. Die Truhenkarte hat damit einen zweiten Zweck neben reiner Kapazität — und einen dritten Preis: Die Runde um die größere Truhe dauert länger (+10 % je Stufe), sodass der Ausbau den Druck sofort senkt und die eigene Antwort darauf zugleich teurer macht.

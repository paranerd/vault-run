...
- **Truhe:** die Schatztruhe in ihrer aktuellen Ausbaustufe, darunter das Wort **Kapazität** und darunter ihr Wert.
- **Lager:** der Erzhaufen in seiner aktuellen Ausbaustufe, ebenso mit seiner Kapazität. Wie voll beide gerade sind, sagt der Balken über dem Abschnitt.

Beschriftung **über** dem Wert, beides mittig: Nebeneinander teilten sich Wort und Zahl die Breite der Kachel, und ein Hort im Millionenbereich hätte dort nur noch als Stummel Platz gehabt. Übereinander bekommt die Zahl die ganze Kachelbreite, und die Zeile darüber ändert sich nie.

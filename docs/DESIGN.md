...
**Dass ein wachsendes Tempo die Wege trotzdem verkürzt, ist keine Sonderregel, sondern die Definition von Tempo.** Eine Strecke kostet `Länge ÷ Geschwindigkeit`. Beide Wege haben seither eine feste Länge (12 s für die Fuhre, 1,5 s für den Wachgang — die Sekunden auf dem Anfangstempo), und die wachsende Zahl steht im Nenner. Damit gibt es keine Stelle mehr, an der ein „mehr ist besser“ von Hand in ein „weniger ist besser“ übersetzt werden müsste: Die Richtung fällt aus der Rechnung, nicht aus einer Konvention. Der Faktor ist der Kehrwert des früheren 0,88, jede Stufe macht also denselben Sprung wie vorher — nur von der anderen Seite gelesen.

Eine Feinheit steckt in den **Böden**. Kein Weg wird beliebig kurz, und ab dem Boden macht keine weitere Stufe ihn noch schneller. Eine Karte, die dort weiter steigende Zahlen zeigte, forderte zu einem Kauf ohne Wirkung auf — genau das, was der Beutel über der Lagergröße vermeidet, indem er vorher und nachher dieselbe Zahl zeigt. Die Stiefelkarte nennt deshalb nicht das rohe Tempo, sondern das, was auf der **Fuhre** tatsächlich ankommt (`bootsPace` statt `bootsSpeed`): Solange kein Boden greift, sind beide dasselbe; darüber steht die Zahl still. Gemessen wird an der Fuhre, weil sie ihren Boden von beiden Wegen als Letzte erreicht — solange sie noch schneller wird, tun die Stiefel noch etwas. Dass der Wachgang seinen eigenen, früheren Boden hat, steht als Hinweis unter der Karte; es ist eine Eigenschaft dieses Weges, nicht der Stiefel.
